		...
		<>
			...
			<div className="col">
				...
				<div>
					...
					<div className="row row-cols-lg-3 mb-5 row-cols-md-2 row-cols-1 g-3 animate__animated animate__fadeIn justify-content-center" style={{display: showSearch ? 'none' : ''}}>
						{
							heroes.map(heroe => (
